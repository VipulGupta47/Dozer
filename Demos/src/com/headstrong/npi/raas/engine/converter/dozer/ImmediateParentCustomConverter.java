...
public class ImmediateParentCustomConverter implements CustomConverter {
...
//		else {
//			throw new MappingException("Converter ImmediateParentCustomConverter "
	...
	public Object mapOwnersToCobsBeneficial(List<OwnershipCorporate> sourceList, List<AttributeCompany> destList) {
		...
		for(OwnershipCorporate corporate: sourceList) {
			if(corporate.getLevel().getValue() == null 
					|| !(corporate.getLevel().getValue().equalsIgnoreCase("Immediate"))) {
				continue;
			}
