...
/**
 * <p>Java class for DictionaryCurrency.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DictionaryCurrency">
 ...
 * 
 */
@XmlType(name = "DictionaryCurrency")
@XmlEnum
public enum DictionaryCurrency {
    ...
    public static DictionaryCurrency fromValue(String v) {
        for (DictionaryCurrency c: DictionaryCurrency.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
